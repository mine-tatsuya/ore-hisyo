  ...
  return (
    <aside className="hidden md:flex flex-col w-60 bg-white border-r border-slate-200 h-screen sticky top-0 shrink-0">
      ...
      <div className="h-14 flex items-center px-4 border-b border-slate-100">
        <span className="text-base font-bold text-slate-900 tracking-tight">🤖 俺秘書</span>
      </div>
      ...
      <div className="p-3 border-t border-slate-100">
        ...
        <button
          ...
          className="w-full flex items-center gap-2.5 px-3 py-2 rounded-lg text-sm text-slate-500 hover:bg-slate-50 hover:text-slate-700 transition-all duration-150"
        >
